...
from .utils import download_url, check_integrity, noisify,noisify_instance, noisify_instance_cifar100
    ...
    def __getitem__(self, index):
        ...
        if self.train:
            if self.noise_type != 'clean':
                # img, target, gt = self.train_data[index], self.train_noisy_labels[index],self.train_labels[index]
                img, target = self.train_data[index], self.train_noisy_labels[index]
            else:
                # img, target,gt = self.train_data[index], self.train_labels[index],self.train_labels[index]
